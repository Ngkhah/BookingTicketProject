    ...
    const renderLogin = () => {
        if (_.isEmpty(userLogin)) {
            return <Fragment>
                <button onClick={() => {
                    history.push('/login')
                }} className="self-center px-8 py-3 rounded text-xl">Đăng ký</button>
                <button onClick={() => {
                    history.push('/login')
        ...
        return <Fragment> <button onClick={() => {
        ...
        }} className="self-center py-3 rounded text-lg font-bold"><UserOutlined style={{ fontSize: '25px' }} /> XIN CHÀO,  {userLogin.hoTen} !</button>
            ...
            }} className="self-center px-3 py-3 rounded text-lg italic ">Thoát</button></Fragment>
    ...
    const renderLoginMB = () => {
        if (_.isEmpty(userLogin)) {
            return <Fragment>
                ...
                <button onClick={() => {
                    history.push('/login')
                }} className="text-lg self-center px-4 py-2 font-semibold rounded bg-violet-500 hover:bg-violet-400 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 ">Đăng nhập</button>
            </Fragment>
        }
        return <Fragment> <button onClick={() => {
            history.push('/profile')
            ...
            <button onClick={() => {
                ...
                history.push('/home');
                window.location.reload();
            }} className="self-center px-4 py-2 rounded text-lg">Đăng xuất</button></Fragment>
